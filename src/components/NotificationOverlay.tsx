        ...
        {notifications.map((notif) => (
          <motion.div
            ...
            className={cn(
              ...
              notif.type === 'CALL' ? "bg-teal-600/95 border-teal-500 text-white" : 
              notif.type === 'SMS' ? "bg-slate-900/95 border-slate-800 text-white" : "bg-slate-900 border-slate-700/70"
            )}
          >
            <div className={cn(
              "w-12 h-12 rounded-xl flex items-center justify-center shrink-0",
              notif.type === 'CALL' ? "bg-slate-800/40" : 
              notif.type === 'SMS' ? "bg-slate-800/40" : "bg-teal-900/45 text-teal-600"
            )}>
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between mb-1">
                ...
                <button onClick={() => removeNotification(notif.id)} className="p-1 hover:bg-slate-800/30 rounded-full transition-colors">
                  <X size={14} />
                </button>
              </div>
