    ...
    <div className="max-w-4xl mx-auto space-y-16 py-8">
      <section className="text-center space-y-6">
        <motion.div 
          ...
          className="w-20 h-20 bg-teal-900/45 rounded-3xl flex items-center justify-center text-teal-600 mx-auto mb-8 shadow-lg shadow-teal-100"
        >
          <Pill size={40} />
        </motion.div>
        <h1 className="text-4xl font-bold text-slate-50 tracking-tight">About SmartMed</h1>
      ...
      <div className="grid md:grid-cols-2 gap-12">
        <div className="space-y-6">
          <h2 className="text-2xl font-bold text-slate-50">Our Mission</h2>
        ...
        <div className="bg-teal-950/40 p-8 rounded-3xl border border-teal-800/60 flex items-center justify-center">
          <div className="text-center space-y-4">
            <div className="text-5xl font-black text-teal-600">1M+</div>
            <p className="text-teal-200 font-bold uppercase tracking-widest text-sm">Doses Tracked</p>
            <p className="text-teal-300 text-sm">Helping patients stay healthy every day.</p>
          </div>
        </div>
      </div>

      <section className="space-y-12">
        <h2 className="text-2xl font-bold text-slate-50 text-center">Our Core Values</h2>
      ...
      <section className="bg-slate-900 p-12 rounded-[40px] text-white text-center space-y-8">
        ...
        <button className="px-8 py-4 bg-teal-600 text-white rounded-full font-bold hover:bg-teal-700 transition-all shadow-lg shadow-teal-900/50">
          Get Started Now
        </button>
      </section>
    </div>
...
function ValueCard({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  return (
    <div className="p-8 rounded-3xl bg-slate-900 border border-slate-800 shadow-sm text-center space-y-4">
